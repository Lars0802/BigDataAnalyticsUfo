...
\input{report-ufo-pre}
\input{report-ufo-part1}
\input{report-ufo-part2}
\input{report-ufo-part3}
\input{report-ufo-part4}
\input{report-ufo-part5}
\input{report-ufo-sum}


%\bibliographystyle{ACM-Reference-Format}
%\bibliography{report-ufo}
\nocite{*}
